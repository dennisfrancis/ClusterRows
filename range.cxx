...
bool range::isCellEmpty(const Reference<XSpreadsheet>& rxSheet, sal_Int32 nCol, sal_Int32 nRow)
{
...
bool range::isColumnEmpty(const Reference<XSpreadsheet>& rxSheet, sal_Int32 nCol,
...
bool range::isRowEmpty(const Reference<XSpreadsheet>& rxSheet, sal_Int32 nRow, sal_Int32 nStartCol,
                       sal_Int32 nEndCol)
{
...
void range::shrinkRangeToData(const Reference<XSpreadsheet>& rxSheet,
                              CellRangeAddress& rRangeExtended)
{
...
void range::expandRangeToData(const Reference<XSpreadsheet>& rxSheet,
                              CellRangeAddress& rRangeExtended)
{
    sal_Int32 nStartCol = rRangeExtended.StartColumn;
    sal_Int32 nEndCol = rRangeExtended.EndColumn;
    ...
    {
        bool bColEmpty = range::isColumnEmpty(rxSheet, nCol, nStartRow, nEndRow);
        if (bColEmpty)
        {
            bStop = true;
            nStartCol = nCol + 1;
    ...
    {
        bool bRowEmpty = range::isRowEmpty(rxSheet, nRow, nStartCol, nEndCol);
        if (bRowEmpty)
        {
            bStop = true;
            nStartRow = nRow + 1;
...
void range::excludeResultColumns(const Reference<XSpreadsheet>& rxSheet,
                                 CellRangeAddress& rRangeExtended)
{
...
bool range::hasHeader(const Reference<XSpreadsheet>& xSheet, CellRangeAddress& aRange)
{
...
OUString range::getCellAddressRepr(sal_Int32 nColumn, sal_Int32 nRow)
{
...
OUString range::getCellRangeRepr(const CellRangeAddress& aRange)
{
    return range::getCellAddressRepr(aRange.StartColumn, aRange.StartRow) + ":"
           + range::getCellAddressRepr(aRange.EndColumn, aRange.EndRow);
}

sal_Int32 range::findMaxInColumn(const Reference<XSpreadsheet>& rxSheet, sal_Int32 nCol,
                                 sal_Int32 nStartRow, sal_Int32 nEndRow)
{
    Reference<XCell> xCell;
    sal_Int32 nMax = -1;
